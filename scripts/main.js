...
console.log(data);
    ...
    <ul class="collection songs">
      ...
      <span class="song-list"><i class="material-icons">queue_music</i><strong>${song.artist.name}</strong> - ${song.title}</span>
      <a href="#!" class="secondary-content"><button class="btn lyrics-btn" data-artist="${song.artist.name}" data-songtitle="${song.title}" data-img="${song.artist.picture_xl}" data-preview="${song.preview}">Get Lyrics</button></a>
    </li>`
        )
        .sort()
        .join('')}
                  ...
                  <div class="card-panel z-depth-4">
                    <div class="lyrics-page--header">
                      <div id="img-container">
                        <div class="card">
                          <span class="songInfo white-text"><strong>${artist}</strong> - ${songTitle}</span>
                        </div>
                        <audio 
                          controls
